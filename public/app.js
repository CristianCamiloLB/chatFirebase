...
firebase.auth().onAuthStateChanged(user => {
    if(user){
        ...
        contenidoProtegido.innerHTML = /*html*/`
            <p class="text-center lead nt-5">Bienvenido ${user.displayName}</p>
        `
        ...
        contenidoProtegido.innerHTML = /*html*/`
        <p class="text-center lead nt-5">Debes iniciar sesion</p>
    `
            ...
            query.forEach(doc => {
                ...
                contenidoProtegido.innerHTML += /*html*/`
                        <div class="d-flex justify-content-start">
                            <span class="badge badge-pill badge-secundary">${doc.data().texto}</span>
                        </div>
                    `
            }
